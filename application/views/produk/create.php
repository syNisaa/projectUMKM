    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <form action="<?php echo base_url('index.php/produk/create') ?>" method='POST' enctype="multipart/form-data">
                        <div class="form-grup">
                        ...
                        <div class="form-grup">
                            ...
                            <input type="text" class='form-control' name='harga_beli'><br>

                        </div>
                        <div class="form-grup">
                            <label class='font-weight-bold'>harga jual</label>
                            <input type="text" class='form-control' name='harga_jual'><br>
