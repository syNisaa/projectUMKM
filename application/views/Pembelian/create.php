    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <form action="<?php echo base_url('index.php/pembelian/create') ?>" method='POST' enctype="multipart/form-data">
                        ...
                        <div class="form-grup">
                            ...
                            <label class='font-weight-bold'>Harga Pembelian</label>
                        ...
                        <div class="form-grup">
                            ...
                            <label class='font-weight-bold'>Produk Pembelian</label>
