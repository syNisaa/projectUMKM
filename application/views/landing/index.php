...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-">
                    <div class="right-content">
                        <?php foreach ($jenis_produk as $jp1) { ?>
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="right-first-image">
                                        <div class="thumb">
                                            <div class="inner-content">
                                                <h4><?php echo $jp1->nama ?></h4>
                                                <span>Best Clothes In Indonesia</span>
                                            </div>
    ...
    <!-- ***** Men Area Starts ***** -->
    <?php foreach ($jenis_produk as $jp2) {?>
    <section class="section" id="men">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        <h2><?php echo $jp2->nama ?> Latest</h2>
