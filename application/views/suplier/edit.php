        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Nama Suplier</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                ...
                <?php foreach ($suplier as $jp) {?>
                    <form action="<?php echo base_url('index.php/suplier/update') ?>" method='POST' enctype="multipart/form-data">
                    ...
                    <div class="form-grup"> 
                            ...
                            <input type="text" class='form-control' name="kota" value="<?php echo $jp->kota ?> "><br>
                    </div>
                    <div class="form-grup"> 
                            <label class='font-weight-bold'>Kontak</label>
                            <input type="text" class='form-control' name="kontak" value="<?php echo $jp->kontak ?> "><br>
                    </div>
                    <div class="form-grup"> 
                            <label class='font-weight-bold'>Alamat</label>
                            <input type="text" class='form-control' name="alamat" value="<?php echo $jp->alamat ?> "><br>
                    </div>
                    <div class="form-grup"> 
                            <label class='font-weight-bold'>Telpon</label>
                            <input type="text" class='form-control' name="telpon" value="<?php echo $jp->telpon ?> "><br>
                    </div>
